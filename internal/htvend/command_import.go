...
var _ flags.Commander = &ImportCommand{}

type ImportCommand struct {
	ManifestOptions

	DestinationDaemonSocket string `long:"destination" description:"Path of socket file for destination"`
}

func (rc *ImportCommand) Execute(args []string) (retErr error) {
	...
	return doValidate(&validateCtx{
		...
		ValidateSHA256: true,
		SaveToDest:     true,
		DestSocket:     rc.DestinationDaemonSocket,
	})
}
